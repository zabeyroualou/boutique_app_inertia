@extends('layout')
@section('content')
<section class="bg-gray-50 py-8 antialiased wihte:bg-gray-900 md:py-16">
    <div class="mx-auto max-w-screen-xl px-4 2xl:px-0">
      <div class="mb-4 flex items-center justify-between gap-4 md:mb-8">
        <h2 class="text-xl font-semibold text-gray-900 dark:text-dark sm:text-2xl">Shop by category</h2>
